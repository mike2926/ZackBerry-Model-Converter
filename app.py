...
st.set_page_config(page_title="ZackBerry Deep Fix", page_icon="💎")
st.title("💎 ZackBerry Ultimate Deep-Fix")
...
if uploaded:
    if st.button(f"🚀 CONVERT {len(uploaded)} MODELS"):
        ...
        st.download_button("📥 Download", master_zip.getvalue(), "ZackBerry_DeepFix.zip")
